...
public abstract class BaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
	...
	protected DisplayImageOptions mOptions = new DisplayImageOptions.Builder().cacheInMemory()
			.showImageForEmptyUri(R.drawable.list_img_default).showStubImage(R.drawable.list_img_default).cacheOnDisc()
			.cacheInMemory().build();
